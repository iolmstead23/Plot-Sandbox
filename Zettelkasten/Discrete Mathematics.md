...
3. **[[Graph Theory]]**
    ...
    - **Connections:** Related to network theory, [[Algorithm|algorithms]], and [[optimization]] in operations research.
4. **[[Combinatorics]]**
...
5. **Number Theory**
    ...
    - **Connections:** Basis for cryptography and [[Algorithm|algorithms]].
6. **[[Algorithm|Algorithms]] and Complexity**
    
    - Study of procedures or rules ([[Algorithm|algorithms]]) for solving problems and the resources required (complexity).
...
9. **Theory of Computation**
    ...
    - **Connections:** Related to automata theory, [[Algorithm|algorithms]], and [[Set Theory]].
...
6. **[[Computer Science]]:**
    ...
    - Fundamental for [[Algorithm|algorithms]], [[data]] structures, programming languages, and databases.
